...
func init() {
	...
	flag.StringVar(&celExpression, "filter", `"dra.net/type" in attributes && attributes["dra.net/type"].StringValue  != "veth"`, "CEL expression to filter network interface attributes (v1beta1.DeviceAttribute).")
